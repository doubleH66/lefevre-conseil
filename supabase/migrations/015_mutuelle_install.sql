-- =============================================================================
-- 015 — Installation complète simulateur mutuelle (UN SEUL FICHIER)
-- Prérequis : migration 011 appliquée (create_admin_notification, is_admin, etc.)
--
-- Utilisez CE fichier si :
--   • mutuelle_leads n'existe pas (erreur 42P01)
--   • vous n'avez pas encore exécuté la 012 avec succès
--
...
-- ---------- RPC soumission (supprime anciennes signatures) ----------
