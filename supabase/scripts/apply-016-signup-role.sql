-- Copier-coller dans Supabase SQL Editor (projet gyisrwfapphqqdbpujtb).
-- Identique à supabase/migrations/016_restore_signup_requested_role.sql
...
-- Promouvoir elfarissih7@gmail.com si besoin
update public.profiles p
set role = 'admin'::public.app_role,
    updated_at = now()
from auth.users u
