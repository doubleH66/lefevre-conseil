...
/** Libellés nav sur fond sombre : même couleur / graisse / tailles que le texte du CTA « Faire une simulation » (hero). */
export const heroNavLinkOnDarkClassName =
  "font-sans text-sm font-semibold leading-none tracking-normal text-white sm:text-base xl:text-[15px]";

/** Libellés nav sur fond clair (pill dockée) : même logique typographique, encre bleu cabinet. */
export const heroNavLinkOnLightClassName =
  "font-sans text-sm font-semibold leading-none tracking-normal text-[#1f2a7c] sm:text-base xl:text-[15px]";
