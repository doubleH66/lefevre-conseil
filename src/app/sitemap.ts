...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}${ROUTES.simulateurs}`, lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${SITE_URL}${ROUTES.simulateurMutuelle}`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}${ROUTES.comparateur}`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
